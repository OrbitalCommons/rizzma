...
//! [`crate::layout_math`] engine. It parses a label into
//! [`rizzma_text::TextRun`] spans, lays out plain spans with
//! [`FontSource::text_to_path`](rizzma_text::FontSource::text_to_path) and math
//! spans with [`crate::layout_math`], and concatenates the resulting glyph/rule
...
//! [`FontSource::text_to_path`](rizzma_text::FontSource::text_to_path) /
//! [`FontSource::measure`](rizzma_text::FontSource::measure), so non-math text
//! remains unchanged.
...
/// [`FontSource::text_to_path`](rizzma_text::FontSource::text_to_path) and math
/// spans with [`crate::layout_math`]. Spans are placed left to right, advancing a
...
/// [`FontSource::measure`](rizzma_text::FontSource::measure); an empty string

...
//!
//! Scope matches [`crate::metrics`]: a single line, left-to-right, no shaping,
...
impl FontSource {
    ...
    /// baseline); see the [module docs](crate::textpath) for orientation details.
    ///
